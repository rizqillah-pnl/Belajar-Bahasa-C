...
using namespace std;
struct data{
char nama_penduduk[20],NIK[20],jenis_kelamin[20],agama[20],tempat_tanggallahir[20];};
data batas[100];
int a,b,c,d;
...
cout<<"\nJumlah Data Yang Akan diinput : ";cin>>b;
   ...
   cout<<"tempat_tanggallahir  : ";cin>>batas[a].tempat_tanggallahir;
   a++;}
   system("cls");
   }
...
{int i,j;
 cout<<"\n===============================Menampilkan Data===============================\n\n";
 cout<<"===============================================================================\n";
 cout<<"|| No|| nama_penduduk|| NIK|| jenis_kelamin|| agama|| tempat_tanggallahir||\n";
 j=0;
 for(i=0;i<a;i++)
 {j=j+1;
  cout<<"===============================================================================\n";
